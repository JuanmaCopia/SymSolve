...
public class Finitization2 {
    ...
    private final Set<ObjSet2> objSets = new LinkedHashSet<>();
    ...
    public Finitization2(Class<?> rootClass) {
        this.rootClass = rootClass;
        rootObjSet = new ObjSet2(rootClass, 1, false);
    ...
    public void set(Class<?> cls, String fieldName, IFieldDomain fieldDomain) {
        ...
        } else if (fieldDomain instanceof ObjSet2) {
            objSets.add((ObjSet2) fieldDomain);
        }
    }
